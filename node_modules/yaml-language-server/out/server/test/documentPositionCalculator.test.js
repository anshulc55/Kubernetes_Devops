...
describe('DocumentPositionCalculator Tests', () => {
    describe('binarySearch', function () {
        it('Binary Search where we are looking for element to the left of center', () => {
            ...
            const find = 2;
            const result = documentPositionCalculator_1.binarySearch(arr, find);
    ...
    describe('getLineStartPositions', function () {
        it('getLineStartPositions with windows newline', () => {
            ...
            const result = documentPositionCalculator_1.getLineStartPositions(test_str);
    ...
    describe('getPosition', function () {
        it('getPosition', () => {
            const test_str = 'test: test\r\ntest: test';
            const startPositions = documentPositionCalculator_1.getLineStartPositions(test_str);
            const result = documentPositionCalculator_1.getPosition(0, startPositions);
        ...
        it('getPosition when not found', () => {
            const test_str = 'test: test\ntest: test';
            const startPositions = documentPositionCalculator_1.getLineStartPositions(test_str);
            const result = documentPositionCalculator_1.getPosition(5, startPositions);
            assert.notEqual(result, undefined);
            assert.equal(result.line, 0);
